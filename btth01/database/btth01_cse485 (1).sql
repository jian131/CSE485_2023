...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2024 at 05:47 PM
...
(1, 'Lòng mẹ', 'Lòng mẹ', 2, 'Và mẹ ơi đừng khóc nhé! Cả đời này mẹ đã khóc nhiều lắm rồi, hãy cười lên vì con đã trưởng thành! Con sẽ lại về dậy sớm nấu cơm cho mẹ, nấu nước cho mẹ tắm như ngày xưa. “Dù cho vai nắng nhưng lòng thương chẳng nhạt màu, vẫn mơ quay về vui vầy dưới bóng mẹ yêu”', '', 1, '0000-00-00 00:00:00', '/btth01/images/songs/69793665.jpg'),
...
(8, 'Tâm tình', NULL),
(10, 'aladin', '/btth01/images/authors/673708.png');
