...
if(isset($_GET['id'])) {
    ...
    die("Không có id tác giả được cung cấp");
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(isset($_FILES['txtAuthorImage']) && $_FILES['txtAuthorImage']['error'] == 0) {
        ...
        $hinh_tgia = $author['hinh_tgia']; // Keep the existing image if no new file is uploaded
    }
            ...
            <div class="col-sm">
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtAuthorName" value="<?= htmlspecialchars($author['ten_tgia']) ?>">
                    </div>
                    ...
                    <?php if (!empty($author['hinh_tgia'])): ?>
                        <div class="mt-3 mb-3">
                            <img src="<?= $author['hinh_tgia'] ?>" alt="Current Image" style="max-width: 200px;">
                            <p>Current image: <?= basename($author['hinh_tgia']) ?></p>
                        </div>
                    <?php endif; ?>
