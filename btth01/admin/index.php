<?php
require_once 'C:\xampp\htdocs\btth01\db_connection.php';
...
// Đếm số lượng
$count_users = countRows($pdo, 'users');
$count_theloai = countRows($pdo, 'theloai');
$count_tacgia = countRows($pdo, 'tacgia');
$count_baiviet = countRows($pdo, 'baiviet');
