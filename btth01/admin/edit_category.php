...
if(isset($_GET['id'])) {
    ...
    die("Không có id thể loại được cung cấp");
}
            ...
            <div class="col-sm">
                ...
                <form action="" method="post">
                    ...
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" name="txtCatName" value="<?= htmlspecialchars($category['ten_tloai']) ?>">
                    </div>
